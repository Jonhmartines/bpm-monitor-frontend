  ...
  return (
    <div className={`min-w-0 rounded-3xl p-5 ${temaEscuro ? "bg-slate-950/70" : "bg-slate-50"}`}>
      ...
      <div className="overflow-x-auto pb-2">
        <svg viewBox={`0 0 ${largura} ${altura}`} className="h-80 min-w-[1300px]">
    ...
    <main className={`${ui.pagina} relative min-h-screen overflow-hidden transition-colors duration-300`}>
      <div className="absolute inset-0">
        ...
        <div
          className={
            temaEscuro
              ? "absolute inset-0 bg-gradient-to-br from-slate-950/93 via-slate-950/82 to-rose-950/65"
              : "absolute inset-0 bg-gradient-to-br from-white/90 via-white/80 to-rose-100/70"
          }
        />
        ...
        <div
          className={
            temaEscuro
              ? "absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/30 to-slate-950/70"
              : "absolute inset-0 bg-gradient-to-t from-white/70 via-white/25 to-white/40"
          }
        />
      </div>
      ...
      <div className="relative z-10 mx-auto min-h-screen max-w-7xl px-5 py-6">
        ...
        <section className="grid min-h-[calc(100vh-110px)] items-center gap-10 py-8 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="flex justify-center xl:justify-center">
            <div className={`w-full max-w-xl rounded-[2rem] p-7 ${cardAcesso}`}>
              ...
              <form onSubmit={modoCadastro ? cadastrar : entrar} className="flex flex-col gap-4">
                ...
                <button
                  disabled={carregando}
                  className="mt-2 rounded-2xl bg-rose-600 px-4 py-4 text-lg font-black text-white shadow-lg shadow-rose-900/20 transition hover:bg-rose-500 disabled:opacity-60"
                >
  ...
  return (
    <section className="space-y-6">
      ...
      <div className={`grid gap-5 rounded-[2rem] p-5 ${ui.painel} xl:grid-cols-[0.85fr_1.15fr]`}>
        ...
        <div className="min-w-0">
          <GraficoBpm
            dados={leiturasUsuario.slice(0, 20)}
            temaEscuro={temaEscuro}
            titulo="Variação recente"
            forcarSlider={true}
          />
